...
and the dedicated millimeter-wave radar imaging track.
"""
...
'mmWave radar imaging 3D reconstruction','millimeter wave radar imaging 3D reconstruction','4D radar point cloud reconstruction','FMCW MIMO SAR radar 3D imaging','MIMO-SAR FMCW radar 3D reconstruction','mmWave radar point cloud enhancement','mmWave radar point cloud super resolution','mmWave radar neural reconstruction','mmWave radar imaging MobiSys','mmWave radar imaging MobiCom','mmWave radar imaging SenSys','mmWave radar IEEE Transactions on Mobile Computing']
CORE_TERMS=['acoustic','sonar','ultrasound','photoacoustic','optoacoustic','acousto-optic','acousto optic','radar','mmwave','millimeter-wave','millimeter wave','fmcw']
IMAGING_TERMS=['imaging','reconstruction','tomography','holography','nlos','non-line-of-sight','synthetic aperture','sensor fusion','neural rendering','volume rendering','differentiable rendering','3d','bathymetry','surface reconstruction','point cloud','super resolution']
PRIMARY_TERMS=['imaging sonar','forward-looking sonar','synthetic aperture sonar','camera sonar','camera-sonar','acoustic-optical','acoustic optical','opti-acoustic','acoustic non-line-of-sight','acoustic nlos','ultrasound synthetic aperture','acoustic holography','coded acoustic','computational ultrasound','mmwave radar','millimeter-wave radar','millimeter wave radar','4d radar','radar point cloud','mimo-sar','fmcw radar','radar imaging']
...
SESSION=requests.Session(); SESSION.headers.update({'User-Agent':'acoustic-optics-imaging-updater/2.2 (https://github.com/ruixv/acoustic-optics-imaging; mailto:%s)'%os.getenv('CROSSREF_MAILTO','example@example.com')})

...
SESSION=requests.Session(); SESSION.headers.update({'User-Agent':'acoustic-optics-imaging-updater/2.7 (https://github.com/ruixv/acoustic-optics-imaging; mailto:%s)'%os.getenv('CROSSREF_MAILTO','example@example.com')})
